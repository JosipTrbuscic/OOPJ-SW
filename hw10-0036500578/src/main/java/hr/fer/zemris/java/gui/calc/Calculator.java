...
public class Calculator extends JFrame{
	...
	private List<CalculatorButton> createButtons(){
		...
		buttons.add(new CalculatorButton("push", "3,7", l->model.clear()));
		buttons.add(new CalculatorButton("pop", "4,7", l->model.clear()));
		...
		buttons.add(new CalculatorButton("x^n", "5,1", l-> {
			unaryOperations.get("").doOperation(model, inv.isSelected());
		}));
