...
public class SmartScriptParser {
	...
	private ObjectStack stack = new ObjectStack(); // stack data structure
	private Lexer lexer;
	 ...
	 */
	private EchoNode parseEmptyTag(ArrayIndexedCollection params) {
	 ...
	 */
	private boolean checkForArgs(ArrayIndexedCollection params) {
