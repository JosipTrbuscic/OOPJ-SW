...
public class SmartScriptTester {
	 ...
	 * @throws IOException if file with given name cannot be read
	 */
	public static void main(String[] args) throws IOException {
		String docBody = new String(Files.readAllBytes(Paths.get("src/test/resources/test3.txt")),
	...
	/**
	 * Method will create recreate original document
	 * from tree that contains parsed parts
	...
	/**
	 * Method that creates string that represents 
	 * For tag of given node
	 * @param node to recreate
	 * @return string representation of given 
	 * 			node
	 */
